...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_IdleParticlesComponent_MetaData[] = {
		...
		{ "Comment", "// UStaticMesh need not to be constructed, selected in the blueprint, UStaticMeshComponent needs to be constructed\n" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "UStaticMesh need not to be constructed, selected in the blueprint, UStaticMeshComponent needs to be constructed" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_OverlapParticles_MetaData[] = {
		{ "Category", "Item|Particles" },
		{ "Comment", "// UParticleSystem need not to be constructed, selected in the blueprint\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "UParticleSystem need not to be constructed, selected in the blueprint" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AItem_Statics::NewProp_OverlapSound_MetaData[] = {
		{ "Category", "Item|Sound" },
		{ "Comment", "// It keep being null until it sets in blueprint\n" },
		{ "ModuleRelativePath", "Item.h" },
		{ "ToolTip", "It keep being null until it sets in blueprint" },
	};
#endif
	...
	IMPLEMENT_CLASS(AItem, 3192001529);
