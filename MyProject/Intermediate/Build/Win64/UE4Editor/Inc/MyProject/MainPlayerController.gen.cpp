...
#include "MyProject/MainPlayerController.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	MYPROJECT_API UClass* Z_Construct_UClass_AMainPlayerController_NoRegister();
	MYPROJECT_API UClass* Z_Construct_UClass_AMainPlayerController();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMainPlayerController_Statics::NewProp_HUDOverlayAsset_MetaData[] = {
		{ "Category", "Widgets" },
		{ "Comment", "/** Refrence to the UMG asset in the editor */" },
		{ "ModuleRelativePath", "MainPlayerController.h" },
		{ "ToolTip", "Refrence to the UMG asset in the editor" },
	};
#endif
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMainPlayerController_Statics::NewProp_HUDOverlay_MetaData[] = {
		{ "Category", "Widgets" },
		{ "Comment", "/** Variable to hold widget after creating it */" },
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "MainPlayerController.h" },
		{ "ToolTip", "Variable to hold widget after creating it" },
	};
#endif
	...
	IMPLEMENT_CLASS(AMainPlayerController, 368906938);
	template<> MYPROJECT_API UClass* StaticClass<AMainPlayerController>()
	{
		return AMainPlayerController::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_AMainPlayerController(Z_Construct_UClass_AMainPlayerController, &AMainPlayerController::StaticClass, TEXT("/Script/MyProject"), TEXT("AMainPlayerController"), false, nullptr, nullptr, nullptr);
